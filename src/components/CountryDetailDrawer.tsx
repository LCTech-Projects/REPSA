...
export const CountryDetailDrawer = ({ countryName, onClose, selectedYear }: CountryDetailDrawerProps) => {
    ...
    useEffect(() => {
        if (!details?.time_series || Object.keys(chartDimensions).length === 0) return;
        ...
        if (chartRefs.electricityAccess.current && details.time_series.length > 0) {
            ...
            const x = d3.scaleLinear()
                .domain(d3.extent(details.time_series, d => d.year) as [number, number])
                .range([0, chartWidth]);

            const y = d3.scaleLinear()
                .domain([0, d3.max(details.time_series, d => Math.max(
            ...
            // Demand line
            const demandLine = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
                .y(d => y(d.electricity_demand || 0))
                .curve(d3.curveMonotoneX);

            // Generation line
            const generationLine = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
            ...
            g.selectAll(".demand-circle")
                .data(details.time_series.filter(d => d.electricity_demand !== null && d.electricity_demand !== undefined))
                .enter()
                .append("circle")
            ...
            g.selectAll(".generation-circle")
                .data(details.time_series.filter(d => d.electricity_generation !== null && d.electricity_generation !== undefined))
                .enter()
                .append("circle")
        ...
        if (chartRefs.co2Emission.current && details.time_series.length > 0) {
            ...
            const y = d3.scaleLinear()
                .domain([0, d3.max(details.time_series, d => d.carbon_intensity || 0) || 0] as [number, number])
                .range([chartHeight, 0]);

            const line = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
            ...
            g.selectAll(".co2-circle")
                .data(details.time_series.filter(d => d.carbon_intensity !== null && d.carbon_intensity !== undefined))
                .enter()
                .append("circle")
        ...
        if (chartRefs.population.current && details.time_series.length > 0) {
            ...
            const y = d3.scaleLinear()
                .domain([0, d3.max(details.time_series, d => (d.population || 0) / 1000000) || 0] as [number, number])
                .range([chartHeight, 0]);

            const area = d3.area<typeof details.time_series[0]>()
                .x(d => x(d.year))
                .y0(chartHeight)
            ...
            g.selectAll(".population-circle")
                .data(details.time_series.filter(d => d.population !== null && d.population !== undefined))
                .enter()
                .append("circle")
        ...
        if (chartRefs.electricityPerCapita.current && details.time_series.length > 0) {
            ...
            const perCapitaLine = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
                .y(d => y(d.electricity_demand_per_capita || 0))
                .curve(d3.curveMonotoneX);

            const withAccessLine = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
            ...
            g.selectAll(".per-capita-circle")
                .data(details.time_series.filter(d => d.electricity_demand_per_capita !== null && d.electricity_demand_per_capita !== undefined))
                .enter()
                .append("circle")
            ...
            g.selectAll(".with-access-circle")
                .data(details.time_series.filter(d => d.electricity_demand_per_capita_with_access !== null && d.electricity_demand_per_capita_with_access !== undefined))
                .enter()
                .append("circle")
        ...
        if (chartRefs.energyPovertyComparison.current && details.time_series.length > 0) {
            ...
            const maxValue = d3.max(details.time_series, d => 
                Math.max(
                    d.energy_poverty || 0,
            ...
            const electricityLine = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
                .y(d => y(d.energy_poverty || 0))
                .defined(d => d.energy_poverty !== null && d.energy_poverty !== undefined)
                .curve(d3.curveMonotoneX);

            const multidimensionalLine = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
            ...
            g.selectAll(".ep-electricity-circle")
                .data(details.time_series.filter(d => d.energy_poverty !== null && d.energy_poverty !== undefined))
                .enter()
                .append("circle")
            ...
            g.selectAll(".ep-multidimensional-circle")
                .data(details.time_series.filter(d => d.energy_poverty_multidimensional !== null && d.energy_poverty_multidimensional !== undefined))
                .enter()
                .append("circle")
        ...
        if (chartRefs.energyPovertyRuralUrban.current && details.time_series.length > 0) {
            ...
            const ruralLine = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
                .y(d => y(d.energy_poverty_rural || 0))
                .defined(d => d.energy_poverty_rural !== null && d.energy_poverty_rural !== undefined)
                .curve(d3.curveMonotoneX);

            const urbanLine = d3.line<typeof details.time_series[0]>()
                .x(d => x(d.year))
            ...
            g.selectAll(".ep-rural-circle")
                .data(details.time_series.filter(d => d.energy_poverty_rural !== null && d.energy_poverty_rural !== undefined))
                .enter()
                .append("circle")
            ...
            g.selectAll(".ep-urban-circle")
                .data(details.time_series.filter(d => d.energy_poverty_urban !== null && d.energy_poverty_urban !== undefined))
                .enter()
                .append("circle")
                ...
                <div className="p-6">
                    ...
                    {loading ? (
                        <div className="flex items-center justify-center py-20">
                            <span className="text-grey-2 text-[1rem] font-inter">Loading country data...</span>
                        </div>
                    ) : details ? (
                        <>
                            {/* Key Figures */}
                            <div className="flex flex-wrap gap-4 mb-6">
                                <div className="rounded-[8px] p-4 text-white-1 flex-1 min-w-[200px]" style={{ backgroundColor: '#BE2628' }}>
                                    <div className="text-[0.875rem] font-inter mb-1">Electricity</div>
                                ...
                                <div className="bg-grey-1 rounded-[8px] p-4 flex-1 min-w-[200px]">
                                    <div className="text-[0.875rem] font-inter text-grey-2 mb-1">Population</div>
                                    <div className="text-[2rem] font-inter font-bold text-black-1">
                                        {formatNumber(details.key_figures.population)}
                                    </div>
                                </div>
                                <div className="bg-grey-1 rounded-[8px] p-4 flex-1 min-w-[200px]">
                                    <div className="text-[0.875rem] font-inter text-grey-2 mb-1">Energy Poverty</div>
                                    <div className="text-[2rem] font-inter font-bold text-black-1">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <div className="bg-white-1 border border-grey-1 rounded-[8px] p-4 flex-1 min-w-[500px] max-w-full">
                                    <h3 className="text-[0.875rem] font-inter font-semibold text-black-1 mb-4">
                                        Electricity Per Capita (kWh/year)
                                    </h3>
                        ...
                        <div className="flex items-center justify-center py-20">
                            <span className="text-grey-2 text-[1rem] font-inter">No data available for this country</span>
                        </div>
                    )}
                </div>
            </div>
