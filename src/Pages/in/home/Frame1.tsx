    ...
    return (
        <section className="w-full py-[60px] px-[22px] flex flex-col md:flex-row gap-[20px] bg-[url('/images/bg1.png')] bg-cover bg-center bg-no-repeat">
            <div ref={textRef} className={`w-full md:w-1/2 ${textVisible ? 'reveal-up' : 'opacity-0'}`}>
                <h2 className="text-blue-1 text-[2.25rem] lg:text-[3rem] font-semibold leading-11 lg:leading-[3.75rem] tracking-tight">What is Energy Poverty?</h2>
                ...
                <button className="bg-yellow-1 text-blue-1 text-[0.875rem] font-medium font-inter p-[8px] rounded-[8px] h-[64px] w-[205px] mt-[32px] cursor-pointer hover:shadow-lg transition-shadow">Explore REPSA</button>
            </div>
